...
sub fftw_plan_dft(int32 $rank, Pointer[int32] $n, CArray[num64] $in, CArray[num64] $out, int32 $sign, uint32 $flags
...
sub fftw_plan_many_dft(int32 $rank, Pointer[int32] $n, int32 $howmany, CArray[num64] $in, Pointer[int32] $inembed,
    int32 $istride, int32 $idist, CArray[num64] $out, Pointer[int32] $onembed, int32 $ostride, int32 $odist,
...
sub fftw_plan_many_dft_r2c(int32 $rank, Pointer[int32] $n, int32 $howmany, CArray[num64] $in, Pointer[int32] $inembed,
    int32 $istride, int32 $idist, CArray[num64] $out, Pointer[int32] $onembed, int32 $ostride, int32 $odist,
    uint32 $flags --> fftw_plan) is native(LIB) is export { * }
sub fftw_plan_dft_r2c(int32 $rank, Pointer[int32] $n, CArray[num64] $in, CArray[num64] $out, uint32 $flags
    --> fftw_plan) is native(LIB) is export { * }
...
sub fftw_plan_many_dft_c2r(int32 $rank, Pointer[int32] $n, int32 $howmany, CArray[num64] $in, Pointer[int32] $inembed,
    int32 $istride, int32 $idist, CArray[num64] $out, Pointer[int32] $onembed, int32 $ostride, int32 $odist,
    uint32 $flags --> fftw_plan) is native(LIB) is export { * }
sub fftw_plan_dft_c2r(int32 $rank, Pointer[int32] $n, CArray[num64] $in, CArray[num64] $out, uint32 $flags
    --> fftw_plan) is native(LIB) is export { * }
...
sub fftw_plan_many_r2r(int32 $rank, Pointer[int32] $n, int32 $howmany, CArray[num64] $in, Pointer[int32] $inembed,
    int32 $istride, int32 $idist, CArray[num64] $out, Pointer[int32] $onembed, int32 $ostride, int32 $odist,
    fftw_r2r_kind $kind, uint32 $flags --> fftw_plan) is native(LIB) is export { * }
sub fftw_plan_r2r(int32 $rank, Pointer[int32] $n, CArray[num64] $in, CArray[num64] $out, fftw_r2r_kind $kind,
    uint32 $flags --> fftw_plan) is native(LIB) is export { * }
